    ...
    <div className="min-h-screen bg-blue-50 dark:bg-dark-900 text-content dark:text-content-dark">
      <div className="max-w-7xl mx-auto px-4 pt-20 pb-12">
        <h1 className="text-5xl font-extrabold text-gray-900 dark:text-white mb-4">
          <span>From </span>
          <span className="text-accent dark:text-accent-dark">Learning</span>
          <span> to </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
          <div className="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-2xl shadow-card p-6 flex flex-col items-start">
            <div className="flex items-center gap-2 mb-2">
              <FiUsers className="w-7 h-7 text-primary-600 dark:text-accent-dark" />
              <span className="text-xs bg-primary-100 dark:bg-dark-700 text-primary-700 dark:text-white px-2 py-0.5 rounded-full">Active</span>
            </div>
            <div className="text-2xl font-bold text-primary-700 dark:text-accent-dark mb-1">{stats.whatsappCommunity.toLocaleString()}</div>
            <div className="text-gray-600 dark:text-content-dark-muted text-sm">WhatsApp Community Members</div>
          </div>
          <div className="bg-white dark:bg-dark-800 border border-gray-200 dark:border-dark-700 rounded-2xl shadow-card p-6 flex flex-col items-start">
            <div className="flex items-center gap-2 mb-2">
      ...
      <section className="bg-gray-50 dark:bg-dark-800 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="mb-4">
            <span className="inline-block px-4 py-1 rounded-full bg-accent/10 text-accent dark:bg-accent-dark/20 dark:text-accent-dark text-sm font-semibold mb-2">Why SuperLearn?</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white dark:bg-dark-800 border border-gray-100 dark:border-dark-700 rounded-2xl shadow-card p-6 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="bg-blue-100 dark:bg-dark-700 text-blue-700 dark:text-white px-2 py-0.5 rounded text-xs font-medium">Full-time</span>
